...
def seed_users():
    try:
        alice = User(username='alice', email='alice@example.com', password_hash=bcrypt.generate_password_hash('password123').decode('utf-8'))
        bob = User(username='bob', email='bob@example.com', password_hash=bcrypt.generate_password_hash('password123').decode('utf-8'))
        charlie = User(username='charlie', email='charlie@example.com', password_hash=bcrypt.generate_password_hash('password123').decode('utf-8'))
